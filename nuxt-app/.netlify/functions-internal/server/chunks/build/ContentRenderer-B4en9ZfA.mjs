...
import { V as pascalCase, W as kebabCase, q as destr } from '../nitro/nitro.mjs';
...
const globalComponents = ["ProseADVue", "ProseA", "ProseBlockquoteDVue", "ProseBlockquote", "ProseCodeDVue", "ProseCode", "ProseEmDVue", "ProseEm", "ProseH1DVue", "ProseH1", "ProseH2DVue", "ProseH2", "ProseH3DVue", "ProseH3", "ProseH4DVue", "ProseH4", "ProseH5DVue", "ProseH5", "ProseH6DVue", "ProseH6", "ProseHrDVue", "ProseHr", "ProseImgDVue", "ProseImg", "ProseLiDVue", "ProseLi", "ProseOlDVue", "ProseOl", "ProsePDVue", "ProseP", "ProsePreDVue", "ProsePre", "ProseScriptDVue", "ProseScript", "ProseStrongDVue", "ProseStrong", "ProseTableDVue", "ProseTable", "ProseTbodyDVue", "ProseTbody", "ProseTdDVue", "ProseTd", "ProseThDVue", "ProseTh", "ProseTheadDVue", "ProseThead", "ProseTrDVue", "ProseTr", "ProseUlDVue", "ProseUl", "Icon"];
const localComponents = [];
const virtual_nuxt__2FUsers_2Fhouedanou_2FDocuments_2FimaadFG_2FnuxtApp_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  globalComponents,
  localComponents
    ...
    function resolveVueComponent(component) {
      ...
      if (typeof component === "string") {
        ...
        if (globalComponents.includes(pascalCase(component))) {
          ...
          const loader = () => {
            return Promise.resolve().then(() => virtual_nuxt__2FUsers_2Fhouedanou_2FDocuments_2FimaadFG_2FnuxtApp_2Fnode_modules_2F_cache_2Fnuxt_2F_nuxt_2Fcontent_2Fcomponents).then((m) => {
...
const __nuxt_component_3 = Object.assign(_sfc_main, { __name: "ContentRenderer" });

export { __nuxt_component_3 as _ };
//# sourceMappingURL=ContentRenderer-B4en9ZfA.mjs.map
