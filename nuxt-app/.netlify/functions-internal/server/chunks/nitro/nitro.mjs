...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5d5365c2-7bcf-4c3c-8048-d1237fee0beb",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/houedanou/Documents/imaadFG/nuxt-app/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
  ...
  fr: [
    {
      ...
      load: () => import('../_/fr.mjs' /* webpackChunkName: "locale_fr_46json_0ec9d3f9" */),
      cache: true
    }
  ],
  en: [
    {
      ...
      load: () => import('../_/en.mjs' /* webpackChunkName: "locale_en_46json_6731027c" */),
      cache: true
    }
  ],
  pt: [
    {
      ...
      load: () => import('../_/pt.mjs' /* webpackChunkName: "locale_pt_46json_18bb07d8" */),
      cache: true
    }
  ]
};
...
const checksums = {
  "content": "v3.5.0--NU1VTmTCxQREtrboCemUUPbzpTexQzSCwHHtcYSpIsw"
};
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Catalyseur de la Souveraineté et de la Croissance Durable"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"IMAAD Financial Group"};
...
const pathToI18nConfig = {
  ...
  "/financement-souverain": {
    "fr": "/financement-souverain",
    "en": "/financement-souverain",
    "pt": "/financement-souverain"
  },
  "/partenariats-public-prive": {
    "fr": "/partenariats-public-prive",
    "en": "/partenariats-public-prive",
    "pt": "/partenariats-public-prive"
  }
};
const i18nPathToPath = {
  ...
  "/actualites/:slug()": "/actualites/:slug()",
  "/notre-equipe": "/notre-equipe",
  "/nos-activites": "/nos-activites",
  "/capital-risque": "/capital-risque",
  "/financement-souverain": "/financement-souverain",
  "/partenariats-public-prive": "/partenariats-public-prive"
};
...
const _kalEdEDJQ0Nvk33VvP0SB0dFpmeLSusxPvVlusgXSKk = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/EtPEcA6p") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const plugins = [
  _kalEdEDJQ0Nvk33VvP0SB0dFpmeLSusxPvVlusgXSKk
];
...
const _H63eud = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _Xo3YBJ = _messagesHandlerCached;

const _V8BDEn = eventHandler(async (event) => {
...
const _qaYIcK = eventHandler(async (event) => {
...
const _jgS6r9 = lazyEventHandler(() => {
...
const _lazy_PgFh01 = () => import('../routes/api/cms/content.get.mjs');
const _lazy_UYzxyd = () => import('../routes/api/cms/pages.put.mjs');
const _lazy_dLJIPc = () => import('../routes/api/cms/site-info.put.mjs');
const _lazy_CJIfUI = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/cms/content', handler: _lazy_PgFh01, lazy: true, middleware: false, method: "get" },
  { route: '/api/cms/pages', handler: _lazy_UYzxyd, lazy: true, middleware: false, method: "put" },
  { route: '/api/cms/site-info', handler: _lazy_dLJIPc, lazy: true, middleware: false, method: "put" },
  { route: '/__nuxt_error', handler: _lazy_CJIfUI, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _H63eud, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:hash/:locale/messages.json', handler: _Xo3YBJ, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _V8BDEn, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _qaYIcK, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _jgS6r9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_CJIfUI, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, withQuery as A, sanitizeStatusCode as B, getContext as C, parsePath as D, parseQuery as E, baseURL as F, createHooks as G, executeAsync as H, toRouteMatcher as I, createRouter$1 as J, defu as K, getRequestURL as L, getCookie as M, getRequestHeader as N, createDefu as O, parse as P, isEqual as Q, withoutTrailingSlash as R, setCookie as S, deleteCookie as T, isEqual$1 as U, pascalCase as V, kebabCase as W, withLeadingSlash as X, parseURL as Y, encodeParam as Z, encodePath as _, appRootTag as a, withTrailingSlash as a0, handler as a1, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, appRootAttrs as e, appSpaLoaderTag as f, appSpaLoaderAttrs as g, getResponseStatusText as h, getResponseStatus as i, appId as j, defineRenderHandler as k, appTeleportTag as l, appTeleportAttrs as m, getQuery as n, appHead as o, publicAssetsURL as p, destr as q, readBody as r, getRouteRules as s, useNitroApp as t, useRuntimeConfig as u, klona as v, defuFn as w, hasProtocol as x, isScriptProtocol as y, joinURL as z };
