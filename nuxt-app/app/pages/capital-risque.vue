...
const data = pages.capitalRisque
...
<template>
  <div class="page-capital-risque pt-20">
    <DynamicHero 
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="font-playfair text-display text-bleu-nuit mb-4">Description des activités</h2>
          <div class="w-24 h-1 bg-or mx-auto"></div>
        </div>
        
        <div class="grid lg:grid-cols-3 gap-0 overflow-hidden rounded-2xl shadow-2xl">
          <VerticalCard 
            v-for="(item, index) in data.verticaux"
            :key="index"
            :title="item.title"
    ...
    <section class="py-24 bg-ivory overflow-hidden">
      <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="text-center mb-16">
          <span class="font-montserrat text-or text-sm uppercase tracking-widest mb-4 block">Portfolio</span>
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-bleu-nuit text-white">
                ...
                <th class="p-6 font-montserrat uppercase text-sm tracking-widest border-r border-white/10">Client / Pays</th>
                <th class="p-6 font-montserrat uppercase text-sm tracking-widest border-r border-white/10 text-center">Montant</th>
                <th class="p-6 font-montserrat uppercase text-sm tracking-widest text-center">Statut Actuel</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(project, index) in data.projets" :key="index" class="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                ...
                <td class="p-6 font-montserrat text-gray-600 italic">{{ project.client }}</td>
            ...
            <tfoot>
              <tr class="bg-bleu-nuit text-white font-playfair">
                <td colspan="2" class="p-8 text-right text-2xl font-light text-white">Total Valeur Portefeuille</td>
...
<style scoped>
.page-capital-risque :deep(.dynamic-section) {
  padding: 6rem 2rem;
  background: transparent;
}

.page-capital-risque :deep(.dynamic-section .section-title) {
...
.page-capital-risque :deep(.dynamic-section .section-description) {
  background: white;
...
/* Custom styles for vertical cards in this page context */
.vertical-card {
